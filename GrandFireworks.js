...
(function (global) {
  ...
  class GrandFireworks extends EventTarget {
    ...
    destroy(){cancelAnimationFrame(this.raf);clearTimeout(this.fadeTimer);window.removeEventListener('resize',this.onResize);document.removeEventListener('visibilitychange',this.onVisibility);if(this.resizeObserver)this.resizeObserver.disconnect();this.renderer.destroy();this.root.remove();if(this.fpsEl){this.fpsEl.remove();this.fpsEl=null;}if(this.oldPosition!==undefined)this.container.style.position=this.oldPosition;this.state='destroyed';}
